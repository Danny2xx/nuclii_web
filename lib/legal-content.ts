...
export const guidelinesSections: PolicySection[] = [
  {
  ...
  },
  {
    ...
    body: "Nuclii should make reporting and moderation feel calm, built-in, and trustworthy. Reports may be reviewed to protect attendees, hosts, communities, venues, and partners.",
  },
  {
